...
(function(win, doc) {
	'use strict';
	var apiKey = 'AIzaSyB3fk78cyqBDMvE3jkZ3qUTZm4tGqkPd3M';
			...
			prepare = {
				...
				build: function(){
					...
					/*	utils.addCSS('#'+id+' .ytv-video{'
							+'position: relative; padding-bottom: 39.4%; '
							+'height: 0; width: 70%;'
							+'} #'+id+' .ytv-video iframe{'
						...
						utils.ajax.get( utils.endpoints.userInfo(), function(userInfo){
							...
							list += '<div class="ytv-list-header">';
								list += '<a href="'+(user.url)+'" target="_blank">';
									...
									list += '<span><i class="ytv-arrow down"></i>'+(user.title)+
											' &ndash; '+videos.length+' видео</span>';
								list += '</a>';
							list += '</div>';
							
							list += '<div class="ytv-list-inner"><ol>';
							...
							$(".ytv-list-inner").niceScroll({cursorcolor: '#F38F15',cursoropacitymin: 0.8,cursorwidth: 6,autohidemode: false});
